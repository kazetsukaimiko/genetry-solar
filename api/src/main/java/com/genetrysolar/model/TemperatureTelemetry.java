...
public class TemperatureTelemetry extends TelemetryFragment {
    ...
    public void apply(AllTelemetry bucket) {
        ...
        bucket.setThermistor1(getThermistor1());
        bucket.setThermistor2(getThermistor2());
        bucket.setThermistor3(getThermistor3());
        bucket.setThermistor4(getThermistor4());
        bucket.setThermistor5(getThermistor5());
        bucket.setThermistor6(getThermistor6());
        bucket.setTransformerThermistor(getTransformerThermistor());
        bucket.setMosfetThermistor(getMosfetThermistor());
        bucket.setCpuThermistor(getCpuThermistor());
        bucket.setAmbientThermistor(getAmbientThermistor());
        bucket.setTempTelemetryCollected(true);
    }
}
