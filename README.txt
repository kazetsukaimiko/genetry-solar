...
a persistence unit "victorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "victor\pom.xml":
...
artifact ("victor.war") is already built. You can build
