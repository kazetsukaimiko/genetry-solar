...
public class SampleIT {
    ...
    private static final File ARCHIVE = new File("./target/victor.war");
    ...
    public static Archive<?> getEarArchive() {
        ...
        WebArchive war = ARCHIVE.exists()
            ? ShrinkWrap.create(ZipImporter.class, "victor.war")
                    .importFrom(ARCHIVE)
                    .as(WebArchive.class)
            : ShrinkWrap.create(WebArchive.class, "victor.war");
