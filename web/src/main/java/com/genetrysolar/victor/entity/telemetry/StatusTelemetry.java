...
public class StatusTelemetry extends TelemetryFragment {
    ...
    public void apply(AllTelemetry bucket) {
        ...
        bucket.setInverterModes(getInverterModes());
        bucket.setPower(getPower());
        bucket.setHours(getHours());
        bucket.setkWh(getkWh());
        bucket.setVersion(getVersion());
        bucket.setStatusTelemetryCollected(true);
    }
}
